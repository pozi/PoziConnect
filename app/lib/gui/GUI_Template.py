...
###########################################################################
## Python code generated with wxFormBuilder (version Feb 20 2010)
...
class Main ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.helpLink.SetURL(URL='http://www.groundtruth.com.au/placelab/')
		...
		self.aboutLink.SetURL(URL='http://www.groundtruth.com.au/placelab/')
